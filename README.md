...
## Build
$ git clone https://github.com/jpradoar/webmap.git /tmp/webmap
$ docker build -t webmap /tmp/webmap/docker/
...
# Need root
$ for url in "url1.com" "url2.com" "urlx.com"; do nmap -sT -sV -O  -A -T4 --version-all --version-intensity 9 -oX /tmp/webmap/$url_.xml $url
```
